...
certutil -addstore -user -f Root "certificates\trustedPeople\03_trust2408_oces_primary_ca.cer"
...
certutil -addstore -user -f My "certificates\trustedPeople\07_kombit_sp_signing_test_2022-05-21.cer"
