...
certutil -addstore -user -f Root "certificates\trustedPeople\globalsign_ca_for_sp.cer
certutil -addstore -user -f Root "certificates\trustedPeople\globalsign_ca_for_sts.cer
